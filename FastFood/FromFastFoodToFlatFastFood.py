...
inputFile = open( path + "/FastFood/FastFood.geojson", "r" );
...
for feature in nativeFile["features"]:
    if ( "name" in feature["properties"] ):
        ...
        if ( "takeaway" in feature["properties"] ):
            takeaway = feature["properties"]["takeaway"];
        if ( "delivery" in feature["properties"] ):
            delivery = feature["properties"]["delivery"];
        ...
        temp.update( { "delivery":delivery } )
        temp.update( { "takeaway":takeaway } )
...
with open(path + '/FastFood/UncleanedFastFood.geojson', 'w') as outfile:  
