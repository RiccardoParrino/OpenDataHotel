...
inputFile = open( path + "/Monument/UncleanedEditDistanceMonument.geojson", "r" );
nativeFile = json.load( inputFile );
finalFileName = path + "/DatiPerElaborazione/Monument.geojson"
definitiveFile = []
temp = {}
counters = {}
stringSet = set()
...
for element in nativeFile:
    ...
    uri = urify( "monument",element["nome"] );
