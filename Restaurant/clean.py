...
inputFile = open( path + "/Restaurant/UncleanedRestaurant.geojson", "r" );
nativeFile = json.load( inputFile );
finalFileName = path + "/DatiPerElaborazione/Restaurant.geojson"
definitiveFile = []
temp = {}
counters = {}
...
for element in nativeFile:
    ...
    uri = urify( "restaurant",element["nome"] );
