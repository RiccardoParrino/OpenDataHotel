...
inputFile = open( path + "/RailwayStation/UncleanedRailwayStation.geojson", "r" );
nativeFile = json.load( inputFile );
finalFileName = path + "/DatiPerElaborazione/RailwayStation.geojson"
definitiveFile = []
temp = {}
counters = {}
stringSet = set()
...
for element in nativeFile:
    ...
    uri = urify( "railwayStation",element["nome"] );
