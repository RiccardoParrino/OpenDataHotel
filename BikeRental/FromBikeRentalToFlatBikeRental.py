...
inputFile = open( path + "/BikeRental/BikeRental.geojson", "r" );
...
for feature in nativeFile["features"]:
    if ( "operator" in feature["properties"] ):
        ...
        uri = urify( "bikeRental", operatore + " " + indirizzo );
...
with open(path + '/BikeRental/UncleanedBikeRental.geojson', 'w') as outfile:  
