...
inputFile = open( path + "/Bar/Bar.geojson", "r" );
...
for feature in nativeFile["features"]:
    if ( "name" in feature["properties"] or "official_name" in feature["properties"] ):
        ...
        if ( "official_name" in feature["properties"] ):
            nome = feature["properties"]["official_name"];
...
with open(path+'/Bar/UncleanedBar.geojson', 'w') as outfile:  
